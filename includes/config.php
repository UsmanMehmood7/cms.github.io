...
// COMPANY INFORMATION
define('COMPANY_LOGO', 'images/logo.jpg');
define('COMPANY_LOGO_WIDTH', '300');
define('COMPANY_LOGO_HEIGHT', '90');
define('COMPANY_NAME','Ghuncha Brothers');
define('COMPANY_ADDRESS_1','123 Islamabad');
define('COMPANY_ADDRESS_2','Pakistan');
define('COMPANY_ADDRESS_3','Paekinta');
define('COMPANY_COUNTY','US');
define('COMPANY_POSTCODE','10100');

define('COMPANY_NUMBER','Company No: 0312456789'); // Company registration number
...
define('EMAIL_NAME', 'Ghuncha Brothers and Co'); // Email from address
...
define('CURRENCY', 'PKR'); // Currency symbol
...
define('PAYMENT_DETAILS', 'Ghuncha Brothers & Co.<br>Sort Code: 00-00-00<br>Account Number: 12345678'); // Payment information
define('FOOTER_NOTE', 'Ghuncha Brothers & Co.');
